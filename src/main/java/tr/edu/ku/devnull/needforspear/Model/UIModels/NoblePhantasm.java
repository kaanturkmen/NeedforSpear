...
public class NoblePhantasm {
    ...
    private double speed, rotationDegree;
    private GameMap gameMap;
    private Size size;
    private Location location;
    private Long lastUpdateTime, startTimeMoving = 0L;
    private boolean rotatingLeft, rotatingRight, isMovingRight, isMovingLeft, isSpeeding, isMagicActivated, doubleSize;
